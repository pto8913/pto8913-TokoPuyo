...
{
public:
	S_ChoiceButton(DirectX::XMFLOAT2 inSize, ID2D1RenderTarget* inD2DRT, const FChoiceInfos& inChoiceInfos = {}, FSlateInfos inSlateInfos = {}, FSlateButtonAppearance inButtonAppearance = {});
