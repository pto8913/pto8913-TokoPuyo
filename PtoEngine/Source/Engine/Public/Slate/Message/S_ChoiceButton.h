...
{
public:
	S_ChoiceButton(ID2D1HwndRenderTarget* inRt2D, DirectX11& dx, FVector2D inSize, const FChoiceInfos& inChoiceInfos = {}, FSlateInfos inSlateInfos = {}, FSlateButtonAppearance inButtonAppearance = {});
	S_ChoiceButton(ID2D1HwndRenderTarget* inRt2D, DirectX11& dx, const FChoiceInfos& inChoiceInfos = {}, FSlateInfos inSlateInfos = {}, FSlateButtonAppearance inButtonAppearance = {});
