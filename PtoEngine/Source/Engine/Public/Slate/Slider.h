...
{
public:
	S_Slider(ID2D1HwndRenderTarget* inRt2D, FVector2D inSize, FSlateInfos inSlateInfos = {}, FSlateSliderAppearance inAppearance = {});
	S_Slider(ID2D1HwndRenderTarget* inRt2D, FSlateInfos inSlateInfos = {}, FSlateSliderAppearance inAppearance = {});
	virtual ~S_Slider();
