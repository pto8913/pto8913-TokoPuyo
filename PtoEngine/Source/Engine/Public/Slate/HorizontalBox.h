...
{
public:
	S_HorizontalBox(ID2D1HwndRenderTarget* inRt2D, FVector2D inSize, FSlateInfos inSlateInfos = {});		
	S_HorizontalBox(ID2D1HwndRenderTarget* inRt2D, FSlateInfos inSlateInfos = {});
